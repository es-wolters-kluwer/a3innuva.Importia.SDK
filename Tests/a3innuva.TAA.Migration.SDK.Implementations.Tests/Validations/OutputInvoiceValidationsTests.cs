namespace a3innuva.TAA.Migration.SDK.Implementations.Tests
{
    ...
    [Trait("Unit test", "OutputInvoiceValidations")]
    public class OutputInvoiceValidationsTests
    {
        private OutputInvoiceValidation validation;

        public OutputInvoiceValidationsTests()
        {
            this.validation = new OutputInvoiceValidation();
        }

        ~OutputInvoiceValidationsTests()
        {
        ...
        [InlineData("000000")]
        [InlineData("A00000")]
        public void Validate_account_numeric_failed(string Output)
        {
            IOutputInvoice entity = this.CreateEntity();
            entity.PartnerAccount = Output;
        ...
        [InlineData("A11111-1")]
        [InlineData("A1111 1")]
        public void Validate_VatNumber_format_failed(string Output)
        {
            IOutputInvoice entity = this.CreateEntity();
            entity.VatNumber = Output;
        ...
        private IOutputInvoiceLine CreateEntityLine()
        {
